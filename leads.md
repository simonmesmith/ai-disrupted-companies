...
- **TRI (Thomson Reuters)** — Down ~25.0% on adjusted yfinance pricing on 2026-06-22, still below the price gate after capital-return/share-consolidation effects. Raw-price comparisons can overstate the decline; monitor only if the adjusted decline deepens materially past ~30% and legal-AI pressure is tied to operating weakness.
- **DOCU (DocuSign)** — Down only ~0.9% from pre-ChatGPT on 2026-06-22. Citi downgrade and e-signature commoditization thesis are plausible only if price crosses materially lower.
- **SFIX (Stitch Fix)** — Above pre-ChatGPT (+7.7% on 2026-06-22). AI styling could threaten the human stylist model if fundamentals deteriorate further, but it no longer clears even a basic below-baseline screen.
...
- **DUOL** remains far above pre-ChatGPT despite education disruption concerns (+94.8% on 2026-06-22).
