...
- **TRI (Thomson Reuters)** — Down ~25.6% on adjusted yfinance pricing on 2026-06-19, still below the price gate after capital-return/share-consolidation effects. Raw-price comparisons can overstate the decline; monitor only if the adjusted decline deepens materially past ~30% and legal-AI pressure is tied to operating weakness.
- **DOCU (DocuSign)** — Down only ~2.4% from pre-ChatGPT on 2026-06-19. Citi downgrade and e-signature commoditization thesis are plausible only if price crosses materially lower.
- **SFIX (Stitch Fix)** — Above pre-ChatGPT (+5.5% on 2026-06-19). AI styling could threaten the human stylist model if fundamentals deteriorate further, but it no longer clears even a basic below-baseline screen.
...
- **DUOL** remains far above pre-ChatGPT despite education disruption concerns (+88.6% on 2026-06-19).
...
- At 94 companies, proving AI as the primary cause remains the binding constraint.
