...
## Current State
- **Company count:** 79 (as of 2026-05-05)
...
- **Rejected:** TTD (Trade Desk, -52%) — decline is primarily valuation reset + agency conflicts (Publicis, WPP, Dentsu distancing), not AI. Revenue still growing 19%. Active AI adopter (Koa Agents). CINT (CI&T, -37%) — not evaluated deeply. MKTX (MarketAxess, -34%) — not evaluated deeply.
- **Evaluations used:** 4 of 15 (BL, TTD, NRDY price check, batch checks of ~25 tickers)
- **Search approaches used:** 2 of 5 (leads from memory/NRDY, broad SaaS batch screening + web research agent for new candidates)
...
## Older Sessions Summary (2026-03-24 to 2026-04-06)
- Added 14 companies: CNDT, DV, IT, U, TEAM, CAP.PA, DSY.PA, AI, INFY, SMWB, MNDY, MTCH, FDS, GTLB
- Key strategies that worked: leads from memory, SaaSpocalypse victims, peer analysis, European IT outsourcers, financial data sector
- Key rejections: TRI (repeatedly too modest at -16-21%), MORN (repeatedly borderline at -23-25%, now recovered to -8%), DUOL/INTU (still above pre-ChatGPT), many delisted (SMAR, ZI, NEWR, TWKS, TIXT, TWOU, MTTR, EVBG)
- Productive veins discovered: cybersecurity (QLYS/RPD/TENB), IT services (EPAM/DAVA/GLOB/CAP.PA/INFY), contact center (FIVN/NICE), staffing (RHI/MAN/ASGN/KFRC/KELYA), AI search death spiral (TRIP/ZD/ANGI/BZFD)

## Topic Files
- `failed-candidates.md` - rejected companies with reasons
- `search-strategies.md` - search approaches tried
- `leads.md` - promising candidates for next session
