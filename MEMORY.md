...
- **Also evaluated:**
  - TEAM (Atlassian) - Down 44.2% from pre-ChatGPT ($122.01 -> $68.13). Strong AI disruption angle (AI agents threatening seat-based SaaS, Citi downgrade, 10% layoffs to fund AI pivot). Qualifies — saved as lead for next session.
- **Evaluations used:** 2 of 15
- **Search approaches used:** 1 of 5 (leads from memory)
...
- **Evaluated but rejected:**
  - TWOU (2U) - Filed Chapter 11 bankruptcy mid-2024, delisted, went private
  - BAND (Bandwidth) - AI is a tailwind, not a disruption; voice AI agents driving growth
  - IAS (Integral Ad Science) - No yfinance data available, appears to have data issues
- **Evaluations used:** 4 of 15
- **Search approaches used:** 1 of 5 (leads from memory)

## Session Log: 2026-03-24
- **Added:** CNDT (Conduent) - Business Services / BPO. Pre-ChatGPT $3.96, now $1.28 (-68%).
- **Evaluated but rejected:**
  - TWKS (Thoughtworks) - going private via Apax acquisition at $4.40/share, delisted
  - TIXT (Telus Digital Experience) - acquired by TELUS, delisted Oct 2025
  - XRX (Xerox) - down 89% but decline is more secular printing decline than AI-specific
- **Evaluations used:** 4 of 15
- **Search approaches used:** 1 of 5 (BPO/IT services companies disrupted by AI)
